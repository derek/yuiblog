...
-   The App Framework family of modules, including Model, Controller/Router, and View have received significant enhancements. An overview of the changes was covered in [an earlier blog post](/yuiblog/2011/12/12/app-framework-350/), and a detailed list of changes can be found in the [history](https://github.com/yui/yui3/blob/master/src/app/HISTORY.md) file.
