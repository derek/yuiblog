...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            div.yuimenubar li.yuimenubaritem img#yahoo {
        ...
        <script type="text/javascript">
            ...
            */
            ...
            YAHOO.example.onWindowLoad = function(p_oEvent) {
                ...
                oMenuBar.addItem("Yahoo!");
                
                // Create an icon for the item in the menu bar

                var oYahooIcon = document.createElement("img");
                oYahooIcon.src = "http://us.i1.yimg.com/us.yimg.com/i/us/nt/b/purpley.1.0.gif";
                oYahooIcon.id = "yahoo";
                oYahooIcon.alt = "Yahoo!";


                // Get a reference to the HTML Anchor node inside the menu item of the menu bar

                var oAnchor = oMenuBar.getItem(0).element.firstChild;


                // Replace the text node with the image 

                oAnchor.replaceChild(oYahooIcon, oAnchor.firstChild);
