...
<html>
    <head>
        ...
        <title>Menus from JavaScript with Animation</title>
        ...
        <script type="text/javascript">
            ...
            YAHOO.example.onWindowLoad = function(p_oEvent) {
                ...
                */
                ...
                oCommunications.showEvent.subscribe(onMenuShow, oCommunications, true);
        ...
        <div id="doc" class="yui-t1">
            <div id="hd">
                <!-- start: your content here -->
                    ...
                    <h1>Menus from JavaScript with Animation</h1>
