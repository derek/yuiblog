...
<script>
	function init(tableId) {
		...
		var myDataTable = new YAHOO.widget.DataView("table1", myColumnSet, myDataSource,{});
	}
...
<div id="doc" class="yui-t1"><!-- possible values: t1, t2, t3, t4, t5, t6, t7 -->
	...
	<div id="bd">
		...
		<div id="yui-main">
			<div class="yui-b">
				<div id="demoDetails">
					<p><strong>Date:</strong> April 20, 2007</p>
					<p><strong>Component:</strong>DataTable, Menu</p>
					<p><strong>Version:</strong> v2.2.2</p>
				</div>
				
		<p style="margin:2em">Right-click on the table header to choose which column to hide.</p>
		<div class="yui_datatable" id="table1"></div>		

 
				<p id="clear">This example is part of <a href="http://yuiblog.com">Victor Morales's tutorial on subclassing DataTable</a>.</p>
