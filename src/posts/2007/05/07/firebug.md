...
title: "Job Announcement: The YUI Team Is Hiring an Engineer To Work on Firebug"
...
categories:
  - "Development"
---
It's no secret that [we're fans](/yuiblog/blog/2007/01/26/video-hewitt-firebug/ "Joe Hewitt came to Yahoo in January to demonstrate the new features in Firebug's 1.0 release.") of [Firebug](http://getfirebug.com "GetFirebug.com, the official Firebug website"), the diabolically useful Firefox extension from Joe Hewitt that provides integrated debugging features, DOM inspection, live HTML/CSS/JavaScript manipulation, profiling, and more. Today we're pleased to announce that we're putting our money where our mouth is by contributing back to the Firebug project.

[![](/yuiblog/blog-archive/assets/firebug.gif)](http://getfirebug.com)Toward that end, we're opening a search for a full-time developer to work with Joe on advancing [the Firebug roadmap](http://fbug.googlecode.com/svn/trunk/docs/TODO.txt "The current roadmap for the Firebug project on Google Code."). This developer will be a member of the [YUI team](/yuiblog/blog/2007/03/29/yuiteam/ "The Yahoo! User Interface Library team; from a March blog post here on YUIBlog.") and a full-time Yahoo! employee. The job description follows. If you're interested in applying for this position, please send your résumé, including links to relevant projects/portfolio items, to yui-jobs /at/ yahoo /dash/ inc /dot/ com. (Principals only; no recruiters, please.)

To learn more about Firebug, [visit the website](http://getfirebug.com "The official Firebug website.") and the [project page on Google Code](http://code.google.com/p/fbug/ "The Firebug project page on Google Code."). You may also want to [watch this video](http://us.dl1.yimg.com/download.yahoo.com/dl/ydn/yui/theater/hewitt-firebug.mp4 "Joe Hewitt demonstrates Firebug 1.0 to a Yahoo! audience in January 2007 (129 MB .mp4 video).") of Joe introducing the feature set of Firebug 1.0 (129 MB `.mp4`; also available [on Yahoo! Video in Flash](http://video.yahoo.com/video/play?vid=111597 "Joe Hewitt demonstrates Firebug 1.0 to a Yahoo! audience in January 2007 (Flash video).")). To learn more about the Yahoo! User Interface Library (YUI), [visit our website](http://developer.yahoo.com/yui/), [download YUI](http://developer.yahoo.com/yui/download/), and check in on [the YUI Forums](http://tech.groups.yahoo.com/group/ydn-javascript/).
...
Yahoo! Inc. is an equal opportunity employer. For more information or to search all of our openings worldwide, please visit [http://careers.yahoo.com](http://careers.yahoo.com).