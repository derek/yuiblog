<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN"
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            YAHOO.example.onDOMReady = function () {
            ...
            <div id="bd">
                ...
                <div id="yui-main">
                    <div class="yui-b">
                        ...
                        <p><strong>NOTE:</strong> <em>This example demonstrates how to add submenus via JavaScript to a menu bar built from existing markup.</em></p>
