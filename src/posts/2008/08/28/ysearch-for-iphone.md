...
After cutting out the unnecessary code, the next step was to make our remaining code as small as possible. The [YUI Compressor](http://developer.yahoo.com/yui/compressor/) made this easy, and we were able to save additional bytes by refactoring our code to follow the advice given in Nicholas Zakas's article _[Helping the YUI Compressor](/yuiblog/2008/02/11/helping-the-yui-compressor/)_, which describes several things you can do to help the YUI Compressor generate even more compact code.
