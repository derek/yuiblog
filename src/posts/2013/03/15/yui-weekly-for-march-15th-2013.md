...
title: "YUI Weekly for March 15th, 2013"
author: "Derek Gathright"
date: 2013-03-15
slug: "yui-weekly-for-march-15th-2013"
permalink: /2013/03/15/yui-weekly-for-march-15th-2013/
categories:
  - "YUI Weekly"
---
...
-   At this week's [YUI Open RoundTable](http://www.youtube.com/watch?v=Wc-iiSox7Sc&feature=plcp) Dav demonstrates a YUI release being built by [Grunt](http://gruntjs.com/). For those interested in work on this task, keep and eye on [pull request #467](https://github.com/yui/yui3/pull/467).
    
-   Version bumps this week for the following YUI devtools: [Yeti](https://github.com/yui/yeti), [Yogi](https://github.com/yui/yogi), [Shifter](https://github.com/yui/Shifter), [YUI Doc](https://github.com/yui/yuidoc/), and [Selleck](https://github.com/yui/Selleck/). Upgrade with `npm install -g yeti yogi shifter yuidocjs selleck`.
    
-   New and updated Gallery modules include [i18n-formats](https://github.com/ashiksmd/i18n-formats), [datepicker](https://github.com/zorgnax/yui3-datepicker), [csslist](https://github.com/tilomitra/csslist), and [cssextras](https://github.com/tilomitra/cssextras)