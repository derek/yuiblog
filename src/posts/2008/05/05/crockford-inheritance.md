...
title: "Free Chapter from Douglas Crockford's \"JavaScript: The Good Parts\""
...
categories:
  - "Development"
---
[![Click through to read Ch. 5 of Douglas's forthcoming book.](/yuiblog/blog-archive/assets/crockford-cover.png)](/yuiblog/blog-archive/assets/pdf/crockford-good-parts-ch-5.pdf)The [#2 book on Amazon's JavaScript shelf](http://www.amazon.com/gp/bestsellers/books/3617/ref=pd_zg_hrsr_b_1_5_last) this morning is Douglas Crockford's forthcoming _[Javascript: The Good Parts](http://www.amazon.com/JavaScript-Good-Parts-Douglas-Crockford/dp/0596517742/)_ (currently available for preorder and due for release later this month). In this volume, Douglas articulates a philosophy of coding in JavaScript that builds up on and extends the content of his [popular video series](http://developer.yahoo.com/yui/theater/) and [articles](http://crockford.com/javascript/). The premise, as Douglas puts it: "Most programming languages contain good parts and bad parts. I discovered that I could be a better programmer by using only the good parts and avoiding the bad parts."

Douglas and his editors at O'Reilly were kind enought to let us offer a sneak preview of _JavaScript: The Good Parts_ here:

-   **[Chapter 5: Inheritance](/yuiblog/blog-archive/assets/pdf/crockford-good-parts-ch-5.pdf)** — 1.2MB PDF
...
> 
> [Click here to keep reading](/yuiblog/blog-archive/assets/pdf/crockford-good-parts-ch-5.pdf) (1.2MB; PDF).
