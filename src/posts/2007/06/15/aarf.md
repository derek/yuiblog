...
title: "Implementation Focus: Avenue A | Razorfish"
...
categories:
  - "YUI Implementations"
---
![From left to right: David Lazzarini, Oliver Langan, Chris Nardi, John Kepler, Julia Debari, Fred Welterlin, Ryan Triggs, Vikas Sharma, Marie De Luna](/yuiblog/blog-archive/assets/aarf.jpg)
...
**You've implemented YUI as part of some major projects — when a traveler books travel with Southwest Airlines, they're likely to run into the [YUI Calendar Control](http://developer.yahoo.com/yui/calendar/) as a result of your work, for example. What are some of the most significant customers with which you've used YUI, and what parts of YUI did you use on those projects?**

We used:

-   [AutoComplete Control](http://developer.yahoo.com/yui/autocomplete/) on searches for a major global financial services provider.
-   [Animation](http://developer.yahoo.com/yui/animation/), [DOM](http://developer.yahoo.com/yui/dom/), and [Connection Manager](http://developer.yahoo.com/yui/connection/) Utilities were used to create modal dialogs, drop down menus, and AJAX interactions for the redesign of Intermec Corporation.
-   [Calendar Control](http://developer.yahoo.com/yui/calendar/) for Southwest Airlines and for an intranet application for a leading biotech firm.
-   [DOM Collection](http://developer.yahoo.com/yui/dom/) and [Connection Manager](http://developer.yahoo.com/yui/connection/) on several Yahoo! Projects, including Yahoo! Talent Show.

![The AA|RF redesign of the Intermec website using YUI.](/yuiblog/blog-archive/assets/aarf-intermec.gif)
