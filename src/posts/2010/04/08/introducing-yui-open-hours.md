...
title: "Introducing YUI Open Hours"
author: "Luke Smith"
date: 2010-04-08
...
The first Open Hours will be this Friday from 10am to 12pm PDT. The primary topic will be an introduction to and code review of Lauren Smith's [YUISand Gallery module](http://yuilibrary.com/gallery/show/yuisand). Here's how to participate:

1.  Dial in to 1-888-371-8922 (non-US participants, [email me](mailto:lsmith@yahoo-inc.com) for a local number)
...
The idea is to hold Open Hours weekly or bi-weekly. We'll try to be flexible and evolve Open Hours as we discover with everyone else what the best format, day and time, and structure is. We'll keep the [YUI Event Calendar](http://yuilibrary.com/gallery/calendar/#calendar) updated with upcoming Open Hours and their topics, and we'll post reminders and other important information here as well. If this is the kind of event that interests you, [following @yuilibrary on Twitter](http://twitter.com/yuilibrary) is also a good way to get updates on upcoming sessions.
