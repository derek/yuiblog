...
-   No new releases this week. The current stable is [YUI 3.8.1](/yuiblog/2013/01/23/yui-3-8-1-released/), and latest preview is [YUI 3.9.0pr2](/yuiblog/2013/01/25/yui-3-9-0pr2/). If you are curious about what is coming up next, checkout this week's "[Development Schedule Updates](/yuiblog/2013/01/29/development-schedule-updates/)" blog post.
...
-   Two new [YUIConf 2012](http://lanyrd.com/2012/yuiconf/) videos were published:
    ...
    -   Diego Ferreiro's "[NodeJS+Cocktails — Scaling Yahoo!](/yuiblog/2013/01/28/yuiconf-2012-diego-ferreiro-on-nodejscocktails-scaling-yahoo/)"
    -   Kevin Lamping's "[Scaling YUI in the Enterprise](/yuiblog/2013/01/31/yuiconf-2012-scaling-yui-in-the-enterprise-with-kevin-lamping/)"
