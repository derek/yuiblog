...
<html>
    <head>
        ...
        <title>Top Nav Exmaple</title>

        <!-- Stanard reset, fonts and grids -->
        ...
        <script type="text/javascript">
            ...
            // "beforeShow" event handler for each submenu

            function onBeforeShowSubmenu(p_sType, p_aArguments, p_oMenu) {
            
                this.cfg.setProperty("iframe", true);
            ...
            function onWindowLoad() {
                ...
                do {
                    ...
                    if(aSubmenuItems) {
                        ...
                        oSubmenu.beforeShowEvent.subscribe(onBeforeShowSubmenu, oSubmenu, true);
        ...
        <div id="doc" class="yui-t1">
            <div id="hd">
                <!-- start: your content here -->
                    ...
                    <h1>Top Nav Exmaple <em>[<a href="index.html">Examples Home</a>]</em></h1>
                ...
                <div id="yui-main">
                    <div class="yui-b">
                        ...
                        <div id="yproducts" class="yuimenubar">
                            <div class="bd">
                                <ul class="first">
                                    <li id="communications" class="yuimenubaritem first"><a href="http://communications.yahoo.com/">Communications</a></li>
