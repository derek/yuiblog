...
YAHOO.yui.SiteSearch.setup = function(){
	/* First, we'll create our DataSource, using the Script
	   ...
	   data. */
	var oDataSource = new YAHOO.widget.DS_ScriptNode("http://search.yahooapis.com/WebSearchService/V1/webSearch?appid=3wEDxLHV34HvAU2lMnI51S4Qra5m.baugqoSv4gcRllqqVZm3UrMDZWToMivf5BJ3Mom&region=us&results=15&output=json&site=yuiblog.com", ["ResultSet.Result","Title","Url","ClickUrl"]);
...
YAHOO.util.Event.onDOMReady(function() {
	setTimeout(YAHOO.yui.SiteSearch.init, 150);
});
