...
<html>
    <head>
        ...
        <title>Menus from Markup with Animation</title>
        ...
        <script type="text/javascript">
            ...
            YAHOO.example.onWindowLoad = function(p_oEvent) {
                ...
                // "show" handler for each submenu of the menubar
                ...
                */               
                ...
                oPIM.beforeShowEvent.subscribe(onMenuBeforeShow, oPIM, true);
                ...
                // Add a "show" event handler to each submenu

                oCommunication.showEvent.subscribe(onMenuShow, oCommunication, true);
                oPIM.showEvent.subscribe(onMenuShow, oPIM, true);
                oShopping.showEvent.subscribe(onMenuShow, oShopping, true);
                oEntertainment.showEvent.subscribe(onMenuShow, oEntertainment, true);
                oInformation.showEvent.subscribe(onMenuShow, oInformation, true);
        ...
        <div id="doc" class="yui-t1">
            <div id="hd">
                <!-- start: your content here -->
                    ...
                    <h1>Menus from Markup with Animation</h1>
                ...
                <div id="yui-main">
                    <div class="yui-b">
                       ...
                       <div id="productsandservices" class="yuimenubar">
                        ...
                        <p><strong>NOTE:</strong> <em>This example demonstrates how to build a menubar with submenus created using existing markup.  Alternatively, you can <a href="example05.php">add submenus to a menubar using JavaScript</a>.</em></p>
