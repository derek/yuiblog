...
title: "Jenny Han Donnelly: YUI Engineer (AdaLovelaceDay09)"
...
categories:
  - "Development"
---
![Jenny Han Donnelly, Sr. Engineer, Yahoo; author of YUI DataTable, DataSource and AutoComplete](/yuiblog/blog-archive/assets/jennydonnelly-20090312-164700.jpg)

\[**Note:** This post is part of the YUI team's participation in [Ada Lovelace Day](http://www.pledgebank.com/AdaLovelaceDay), a celebration of female technologists around the world.\]

Jenny Han Donnelly is the author of three YUI components:

1.  **[The DataTable Control](http://developer.yahoo.com/yui/datatable/):** YUI's DataTable is one of our signature UI widgets, providing a powerful menu of interactive options for tabular data.
2.  **[The AutoComplete Control](http://developer.yahoo.com/yui/autocomplete/):** AutoComplete provides typeahead, suggest, filtration and combo-box functionality to any text input area.
3.  **[The DataSource Utility](http://developer.yahoo.com/yui/datasource/):** Shared by DataTable, AutoComplete and the [Charts Control](http://developer.yahoo.com/yui/charts/), DataSource serves as a conduit between widgets and potential sources of data — including server-side data, JavaScript arrays, and DOM structures like HTML tables.
...
\[_[photo of Jenny](http://www.flickr.com/photos/protohiro/413960259/) used by kind permission of Stephen Woods_\]